    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="midnight-panel overflow-hidden rounded-3xl">
          <div className="flex items-end justify-between gap-4 border-b border-blue-400/10 p-5">
            <div className="space-y-3">
            ...
            <div className="h-12 w-56 animate-pulse rounded-xl border border-blue-400/10 bg-blue-500/[0.035]" />
          </div>
          ...
          <div className="space-y-3 p-5">
            {Array.from({ length: 5 }).map((_, rowIndex) => (
              <div
                key={rowIndex}
                className="min-w-[900px] grid grid-cols-7 gap-4 rounded-2xl border border-blue-400/10 bg-blue-500/[0.025] p-4"
              >
        ...
        <aside className="space-y-6">
          <section className="midnight-panel rounded-3xl p-5">
            ...
            <div className="mt-5 h-12 animate-pulse rounded-xl border border-blue-400/10 bg-blue-500/[0.035]" />
            <div className="mt-4 h-24 animate-pulse rounded-2xl border border-amber-300/10 bg-amber-400/[0.035]" />
          </section>
