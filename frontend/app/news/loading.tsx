    ...
    <div className="space-y-6">
      <section className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div className="space-y-3">
          ...
          <div className="h-9 w-60 max-w-full animate-pulse rounded-xl bg-blue-400/10" />
        ...
        <div className="h-16 w-full animate-pulse rounded-2xl border border-amber-300/10 bg-amber-400/[0.04] xl:w-80" />
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <div className="midnight-panel overflow-hidden rounded-3xl">
          <div className="flex items-center justify-between border-b border-blue-400/10 p-5">
            ...
            <div className="h-9 w-52 animate-pulse rounded-xl bg-blue-400/[0.07]" />
          </div>
          ...
          <div className="space-y-3 p-5">
            {Array.from({ length: 5 }).map((_, rowIndex) => (
              <div
                key={rowIndex}
                className="min-w-[900px] grid grid-cols-8 gap-4 rounded-2xl border border-blue-400/10 bg-blue-500/[0.025] p-4"
              >
        ...
        <aside className="space-y-6">
          ...
          <section className="midnight-panel rounded-3xl p-5">
            ...
            <div className="mt-4 h-28 animate-pulse rounded-2xl border border-amber-300/10 bg-amber-400/[0.035]" />
          </section>
        </aside>
      </section>
    </div>
