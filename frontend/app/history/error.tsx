    ...
    <section className="midnight-panel flex min-h-[520px] items-center justify-center rounded-3xl p-6">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-sm leading-6 text-slate-500">
          Blue-Trading-AI could not load verified signal
          records, outcomes, or audit information. This may
          be caused by a temporary backend, database, network,
        ...
        <div className="mt-6 rounded-2xl border border-blue-400/10 bg-blue-500/[0.035] p-4 text-left">
          ...
          <p className="mt-2 text-xs leading-5 text-slate-500">
            Blue-Trading-AI will not display incomplete,
            estimated, duplicated, or unverified historical
            outcomes while the official records source is
            unavailable.
          </p>
        </div>
